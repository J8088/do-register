...
SECRET_KEY = 'sep^k#0)ahsr12qqruy0omxue208o#9lmf4g@i2zk*2xd3#v9^'
...
# }
# addressbase
user = os.getenv('POSTGIS_ENV_POSTGRES_USER', 'ij')
...
db = os.getenv('POSTGIS_ENV_POSTGRES_DB', 'addressbase')
